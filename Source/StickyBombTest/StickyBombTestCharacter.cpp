...
void AStickyBombTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AStickyBombTestCharacter::Move);
...
void AStickyBombTestCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AStickyBombTestCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AStickyBombTestCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AStickyBombTestCharacter::GetHasRifle()
{
	return bHasRifle;
}